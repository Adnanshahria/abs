...
export default function AdminCandidates() {
    ...
    const t = translations[language].admin.candidates;
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50 border-b border-gray-100">
                                <th className="p-4 font-semibold text-gray-600 text-sm">{t.table.valid}</th>
                                <th className="p-4 font-semibold text-gray-600 text-sm">{t.table.name}</th>
                                <th className="p-4 font-semibold text-gray-600 text-sm">{t.table.area}</th>
                                <th className="p-4 font-semibold text-gray-600 text-sm">{t.table.symbol}</th>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative z-10 animate-in zoom-in-95 duration-200">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">{t.form.nameBn}</label>
                                    <input required type="text" className="w-full p-3 rounded-lg border border-gray-200"
                                        value={formData.name_bn} onChange={e => setFormData({ ...formData, name_bn: e.target.value })} />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">{t.form.party}</label>
                                    <input required type="text" className="w-full p-3 rounded-lg border border-gray-200"
                                        value={formData.party} onChange={e => setFormData({ ...formData, party: e.target.value })} />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">{t.form.symbol}</label>
                                    <input required type="text" className="w-full p-3 rounded-lg border border-gray-200"
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">{t.form.education}</label>
                                    <input required type="text" className="w-full p-3 rounded-lg border border-gray-200"
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">{t.form.alliance}</label>
                            ...
                            <div className="p-5 bg-gray-50 rounded-xl border border-gray-200 grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    >
                                        <option value="">{t.form.selectSeat}</option>
