...
const CONTACT_CONTENT_IDS = [
    { id: 'contact_title', label: 'Page Title' },
    { id: 'contact_subtitle', label: 'Page Subtitle' },
    { id: 'contact_email_1', label: 'Primary Email' },
    { id: 'contact_email_2', label: 'Secondary Email' },
    { id: 'contact_phone', label: 'Phone Number' },
    { id: 'contact_address', label: 'Address', isLarge: true },
];
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Edit Contact page content • Auto-saves as you type</p>
                </div>
            </div>

            {/* Content Grid */}
            <div className="space-y-4">
                {CONTACT_CONTENT_IDS.map(({ id, label, isLarge }) => {
